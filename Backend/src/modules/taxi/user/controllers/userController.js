...
export const updateGuardianContacts = async (req, res) => {
  const guardianContacts = Array.isArray(req.body?.guardianContacts)
    ? req.body.guardianContacts
        .map((contact) => ({
