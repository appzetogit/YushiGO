...
adminRouter.get('/admin/pharmacies', listAdminPharmacies);
adminRouter.post('/admin/pharmacies', createAdminPharmacy);
adminRouter.patch('/admin/pharmacies/:id', updateAdminPharmacy);
adminRouter.delete('/admin/pharmacies/:id', deleteAdminPharmacy);
...
adminRouter.get('/admin/medicine-orders', getMedicineOrders);
