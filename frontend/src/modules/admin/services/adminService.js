...
export const adminService = {
  ...
  getMedicineOrders: ({ page = 1, limit = 10, tab = 'all', search = '' } = {}) =>
    api.get(`/admin/medicine-orders?page=${page}&limit=${limit}&tab=${encodeURIComponent(tab)}&search=${encodeURIComponent(search)}`),
  ...
  updatePharmacy: (id, data) => api.patch(`/admin/pharmacies/${id}`, data),
